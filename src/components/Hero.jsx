  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row gap-10 justify-between">
        <div className="text-white w-2/4 mt-52 mx-10">
          <p className="text-4xl font-bold">
            Welcome to <span className="italic text-red-400">Cloud-Crunch</span>
          </p>
          <p>watch your favourite anime here</p>
          ...
          <p>
            ...
            qui sit quisquam fugit, aperiam error suscipit. Tempore?
              ...
              <div className="relative w-1/2">
                  ...
                  <div className="absolute h-[300px]  rounded-2xl w-[200px] top-72 -left-10 backdrop-blur-[10px] bg-[rgba(149,86,86,0.5)]">
                       <img src="/images/h1.png" className="absolute h-[250px]  rounded-2xl w-[150px] top-6.5 -left-5 backdrop-blur-[10px] bg-[rgba(149,86,86,0.3)] opacity-75" alt="" />
                  </div>
                  <div className="absolute h-[250px]  rounded-2xl w-[220px] top-80 left-20 backdrop-blur-[10px] bg-[rgba(149,86,86,0.5)] z-20">
                      <img src="/images/h2.png" className="absolute h-[280px]  rounded-2xl w-[195px] -top-5 left-3.5 backdrop-blur-[10px] bg-[rgba(149,86,86,0.5)] opacity-80 z-20" alt="" />
                  </div>
                  <div className="absolute h-[300px]  rounded-2xl w-[200px] top-72 left-64 backdrop-blur-[10px] bg-[rgba(149,86,86,0.5)] ">
                      <img src="/images/h3.png" className="absolute h-[250px]  rounded-2xl w-[190px] top-6.5 left-6 opacity-80 backdrop-blur-[10px] bg-[rgba(149,86,86,0.5)]  " alt="" />
                  </div>
              </div>
